        ...
        <div id="kt_app_content_container" className="app-container">
          {/* {initialValues ? ( */}
            ...
            <Form
              ...
              submitUrl={process.env.REACT_APP_API_BASE_URL + `videos/${id}`}
              redirectUrl="/videos"
              successMessage="Videos has been updated successfully"
              pageTitle={pageTitle}
            />
		      )}
        </div>
