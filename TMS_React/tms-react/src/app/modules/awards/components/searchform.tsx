        ...
        <div className="row mt-6">
            <div className="row mb-5" style={{ marginBottom: '5px' }}>
                <div className="col-lg-3 mb-lg-0">
                    <label>Name:</label>
                        <input type="text" className="form-control form-control-solid datatable-input" placeholder="Enter Name" data-col-index="{{ $name }}"/>
                    </div>
                    <div className="col-lg-3 mb-lg-0">
                        <label>Year:</label>
                        <input type="text" className="form-control form-control-solid datatable-input" placeholder="Enter Year" data-col-index="{{ $year }}"/>
                    </div>
                </div>
            </div>
            <div className="row ">
