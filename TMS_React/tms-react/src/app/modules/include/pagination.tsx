        ...
        <div className="d-flex justify-content-between align-items-center">
          ...
          <ul className="pagination justify-content-end mb-0">
            ...
            {[...Array(totalPages)].map((_, index) => (
              <li key={index + 1} className={clsx('page-item', { active: currentPage === index + 1, disabled: isLoading })}>
                <button className="page-link" onClick={() => handlePageChange(index + 1)} disabled={isLoading}>
                  {index + 1}
                </button>
              </li>
            ))}
